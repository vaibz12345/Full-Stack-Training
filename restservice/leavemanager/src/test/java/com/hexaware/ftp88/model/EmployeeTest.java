 ...
 */
  @Test
    ...
    assertEquals("7685949390", ob1.getPhone());
    assertEquals("vaibhavsingh161997@gmail.com", ob1.getEmail());
    assertEquals("xyz", ob1.getDept());
    assertEquals(df.parse("12-10-2011"), ob1.getDate());
    assertEquals(2000, ob1.getEmpMgrId());
    assertEquals(20, ob1.getLeaveBal());
  }
  /**
  * unit test for employ.
  * Javadoc for method.
  ...
  */
  @Test
    ...
    ob1.setPhone("7685949390");
    ob1.setEmail("vaibhavsingh@gmail.com");
    ob1.setDept("hubli");
    ob1.setDate(d1);
    ob1.setEmpMgrId(1);
    ob1.setLeaveBal(20);
    ...
    assertEquals("vaibhav", ob1.getEname());
    assertEquals("7685949390", ob1.getPhone());
    assertEquals("vaibhavsingh@gmail.com", ob1.getEmail());
    assertEquals("hubli", ob1.getDept());
    assertEquals(df.parse("12-10-2011"), ob1.getDate());
